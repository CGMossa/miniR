...
weight = 4
description = "The crates miniR uses, why some dependencies travel in bundles, and how feature flags compose"
+++

miniR is one crate with a fairly small always-on core and a long list of optional subsystems. The point of the feature flags is not just smaller binaries. They keep parser and evaluator work fast while letting native code, graphics, linalg, TLS, parquet, and GUI support grow without becoming mandatory for every build.
