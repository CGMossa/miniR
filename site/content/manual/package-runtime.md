...
weight = 2
description = "miniR treats package loading as a runtime subsystem with its own environment model, metadata parsing, native loading path, and help indexing. This page is the reference view of that pipeline."
+++
