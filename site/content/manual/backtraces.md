...
weight = 5
description = "miniR has two related debugging layers: R-level tracebacks and native backtraces. Both are stored per interpreter so failures in one session do not overwrite debugging state in another session."
+++
